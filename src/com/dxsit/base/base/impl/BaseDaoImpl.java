package com.dxsit.base.base.impl;
...
import com.dxsit.base.base.BaseDao;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
	...
	public Object findObjectBySql(String sql, Object... params) {
		...
		Object uniqueResult;
		try {
			Query query =fillQueryByPosition( hibernateTemplate.getSessionFactory()
					.getCurrentSession().createQuery(sql), params);
	...
	public List<T> getListByHQL(String hql, Object... params) {
		log.debug("getListByHQL : " + hql +"  the params is:"+params.toString());
		List<T> find =null;
		try {
	...
	public void executeHqlForUpdate(String hql, Object... params) {
		log.debug("executeHqlForUpdate : " + hql +"  the params is:"+params.toString());
		try {
